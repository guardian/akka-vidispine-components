...
class VSCollectionSearchSource(metadataFields:Seq[String],
  ...
  extends VSGenericSearchSource[VSLazyItem](metadataFields, searchDoc, includeShape, includeAllMetadata, customStartPoint=customStartPoint, pageSize=pageSize, retryDelay=retryDelay, searchType = "collection")(comm, actorSystem, mat) {
